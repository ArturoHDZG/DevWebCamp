<aside class="dashboard__sidebar">
  ...
  <nav class="dashboard__menu">
    <a
      ...
      <?php echo paginaActual('/dashboard') ? 'dashboard__enlace--actual' : ''; ?>"
    >
    ...
    <a
      href="/admin/ponentes"
      class="dashboard__enlace
      <?php echo paginaActual('/ponentes') ? 'dashboard__enlace--actual' : ''; ?>"
    >
    ...
    <a
      href="/admin/eventos"
      class="dashboard__enlace
      <?php echo paginaActual('/eventos') ? 'dashboard__enlace--actual' : ''; ?>"
    >
    ...
    <a
      ...
      class="dashboard__enlace
      <?php echo paginaActual('/registrados') ? 'dashboard__enlace--actual' : ''; ?>"
    >
    ...
    <a
      href="/admin/regalos"
      class="dashboard__enlace
      <?php echo paginaActual('/regalos') ? 'dashboard__enlace--actual' : ''; ?>"
    >
